...
if __name__ == "__main__":
    ...
    hamp_sys = HamParams(hop=0, wilson=lambda_val / 3e3, soc=lambda_val / 1e3, mass=0.05, wdis=0)
    hamp_lead = HamParams(hop=0, wilson=lambda_val / 3e3, soc=lambda_val / 1e3, mass=0.05)
